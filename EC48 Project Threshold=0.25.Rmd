---
title: "EC48E Project Threshold=0.25"
...
```{r}
####### TESTS WITH THRESHOLD = 0.25, SELECTED LONG SPREAD DATA
...
prediction_log_model_t12_tenspread <- ifelse(predict(log_model_t12_tenspread,test_data_t12,type="response")>=0.25,1,0)
roc_log_model_t12_tenspread <- roc(recessions[445:696,2],prediction_log_model_t12_tenspread)
auc(roc_log_model_t12_tenspread) ##### area under the curve of the model: 0.6258
...
prediction_log_model_t15_tenspread  <- ifelse(predict(log_model_t15_tenspread ,test_data_t15,type="response")>=0.25,1,0)
roc_log_model_t15_tenspread  <- roc(recessions[445:696,2],prediction_log_model_t15_tenspread)
auc(roc_log_model_t15_tenspread ) ##### area under the curve of the model:  0.6258
...
prediction_log_model_t18_tenspread  <- ifelse(predict(log_model_t18_tenspread ,test_data_t18,type="response")>=0.25,1,0)
roc_log_model_t18_tenspread  <- roc(recessions[445:696,2],prediction_log_model_t18_tenspread)
auc(roc_log_model_t18_tenspread) ##### area under the curve of the model: 0.6494
...
prediction_log_model_t21_tenspread  <- ifelse(predict(log_model_t21_tenspread ,test_data_t21,type="response")>=0.25,1,0)
roc_log_model_t21_tenspread  <- roc(recessions[445:696,2],prediction_log_model_t21_tenspread )
auc(roc_log_model_t21_tenspread ) ##### area under the curve of the model:  0.5555
...
prediction_log_model_t24_tenspread  <- ifelse(predict(log_model_t24_tenspread ,test_data_t24,type="response")>=0.25,1,0)
roc_log_model_t24_tenspread  <- roc(recessions[445:696,2],prediction_log_model_t24_tenspread )
auc(roc_log_model_t24_tenspread ) ##### area under the curve of the model:   0.5
...
prediction_log_model_t12 <- ifelse(predict(log_model_t12,test_data_t12,type="response")>=0.25,1,0)
roc_log_model_t12 <- roc(recessions[445:696,2],prediction_log_model_t12)
auc(roc_log_model_t12) ##### area under the curve of the model: 0.5362
...
prediction_log_model_t15 <- ifelse(predict(log_model_t15,test_data_t15,type="response")>=0.25,1,0)
roc_log_model_t15 <- roc(recessions[445:696,2],prediction_log_model_t15)
auc(roc_log_model_t15) ##### area under the curve of the model: 0.5533
...
prediction_log_model_t18 <- ifelse(predict(log_model_t18,test_data_t18,type="response")>=0.25,1,0)
roc_log_model_t18 <- roc(recessions[445:696,2],prediction_log_model_t18)
auc(roc_log_model_t18) ##### area under the curve of the model: 0.6302
...
prediction_log_model_t21 <- ifelse(predict(log_model_t21,test_data_t21,type="response")>=0.25,1,0)
roc_log_model_t21 <- roc(recessions[445:696,2],prediction_log_model_t21)
auc(roc_log_model_t21) ##### area under the curve of the model: 0.5917
...
prediction_log_model_t24 <- ifelse(predict(log_model_t24,test_data_t24,type="response")>=0.25,1,0)
roc_log_model_t24 <- roc(recessions[445:696,2],prediction_log_model_t24)
auc(roc_log_model_t24) ##### area under the curve of the model: 0.6154
...
prediction_log_model_t12_all <- ifelse(predict(log_model_t12_all,test_data_t12_all,type="response")>=0.25,1,0)
roc_log_model_t12_all <- roc(recessions[445:696,2],prediction_log_model_t12_all)
auc(roc_log_model_t12_all) ##### area under the curve of the model:  0.5939
...
prediction_log_model_t15_all <- ifelse(predict(log_model_t15_all,test_data_t15_all,type="response")>=0.25,1,0)
roc_log_model_t15_all <- roc(recessions[445:696,2],prediction_log_model_t15_all)
auc(roc_log_model_t15_all) ##### area under the curve of the model:    0.5533
...
prediction_log_model_t18_all <- ifelse(predict(log_model_t18_all,test_data_t18_all,type="response")>=0.25,1,0)
roc_log_model_t18_all <- roc(recessions[445:696,2],prediction_log_model_t18_all)
auc(roc_log_model_t18_all) ##### area under the curve of the model:   0.5192
...
prediction_log_model_t21_all <- ifelse(predict(log_model_t21_all,test_data_t21_all,type="response")>=0.25,1,0)
roc_log_model_t21_all <- roc(recessions[445:696,2],prediction_log_model_t21_all)
auc(roc_log_model_t21_all) ##### area under the curve of the model: 0.5
...
prediction_log_model_t24_all <- ifelse(predict(log_model_t24_all,test_data_t24_all,type="response")>=0.25,1,0)
roc_log_model_t24_all <- roc(recessions[445:696,2],prediction_log_model_t24_all)
auc(roc_log_model_t24_all) ##### area under the curve of the model: 0.4867
...
prediction_log_model_t12_all_PC <- ifelse(predict(log_model_t12_all_PC,test_data_t12_all,type="response")>=0.25,1,0)
roc_log_model_t12_all_PC <- roc(recessions[445:696,2],prediction_log_model_t12_all_PC)
auc(roc_log_model_t12_all_PC) ##### area under the curve of the model: 0.5725
...
prediction_log_model_t15_all_PC <- ifelse(predict(log_model_t15_all_PC,test_data_t15_all,type="response")>=0.25,1,0)
roc_log_model_t15_all_PC <- roc(recessions[445:696,2],prediction_log_model_t15_all_PC)
auc(roc_log_model_t15_all_PC) ##### area under the curve of the model:  0.5488
...
prediction_log_model_t18_all_PC <- ifelse(predict(log_model_t18_all_PC,test_data_t18_all,type="response")>=0.25,1,0)
roc_log_model_t18_all_PC <- roc(recessions[445:696,2],prediction_log_model_t18_all_PC)
auc(roc_log_model_t18_all_PC) ##### area under the curve of the model: 0.4934
...
prediction_log_model_t21_all_PC <- ifelse(predict(log_model_t21_all_PC,test_data_t21_all,type="response")>=0.25,1,0)
roc_log_model_t21_all_PC <- roc(recessions[445:696,2],prediction_log_model_t21_all_PC)
auc(roc_log_model_t21_all_PC) ##### area under the curve of the model: 0.5
...
prediction_log_model_t24_all_PC <- ifelse(predict(log_model_t24_all_PC,test_data_t24_all,type="response")>=0.25,1,0)
roc_log_model_t24_all_PC <- roc(recessions[445:696,2],prediction_log_model_t24_all_PC)
auc(roc_log_model_t24_all_PC) ##### area under the curve of the model: 0.5
