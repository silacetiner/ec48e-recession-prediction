---
title: "EC48E Project Threshold=0.15"
...
```{r}
####### TESTS WITH THRESHOLD = 0.15, SELECTED LONG SPREAD DATA
...
prediction_log_model_t12_tenspread <- ifelse(predict(log_model_t12_tenspread, test_data_t12, type="response") >= 0.15, 1, 0)
roc_log_model_t12_tenspread <- roc(recessions[445:696,2], prediction_log_model_t12_tenspread)
auc(roc_log_model_t12_tenspread) ##### area under the curve of the model:  0.719
plot(roc_log_model_t12_tenspread)
```
...
prediction_log_model_t15_tenspread  <- ifelse(predict(log_model_t15_tenspread, test_data_t15, type="response") >= 0.15, 1, 0)
roc_log_model_t15_tenspread  <- roc(recessions[445:696,2], prediction_log_model_t15_tenspread)
auc(roc_log_model_t15_tenspread) ##### area under the curve of the model: 0.7634
plot(roc_log_model_t15_tenspread)
```
...
prediction_log_model_t18_tenspread  <- ifelse(predict(log_model_t18_tenspread, test_data_t18, type="response") >= 0.15, 1, 0)
roc_log_model_t18_tenspread  <- roc(recessions[445:696,2], prediction_log_model_t18_tenspread)
auc(roc_log_model_t18_tenspread) ##### area under the curve of the model: 0.7931
plot(roc_log_model_t18_tenspread)
```
...
prediction_log_model_t21_tenspread  <- ifelse(predict(log_model_t21_tenspread, test_data_t21, type="response") >= 0.15, 1, 0)
roc_log_model_t21_tenspread  <- roc(recessions[445:696,2], prediction_log_model_t21_tenspread)
auc(roc_log_model_t21_tenspread) ##### area under the curve of the model: 0.7798
plot(roc_log_model_t21_tenspread) 
```
...
prediction_log_model_t24_tenspread  <- ifelse(predict(log_model_t24_tenspread, test_data_t24, type="response") >= 0.15, 1, 0)
roc_log_model_t24_tenspread  <- roc(recessions[445:696,2], prediction_log_model_t24_tenspread)
auc(roc_log_model_t24_tenspread) ##### area under the curve of the model:  0.74
plot(roc_log_model_t24_tenspread)
```
...
prediction_log_model_t12 <- ifelse(predict(log_model_t12, test_data_t12, type="response") >= 0.15, 1, 0)
roc_log_model_t12 <- roc(recessions[445:696,2], prediction_log_model_t12)
auc(roc_log_model_t12) ##### area under the curve of the model: 0.7257
plot(roc_log_model_t12)
```
...
prediction_log_model_t15 <- ifelse(predict(log_model_t15, test_data_t15, type="response") >= 0.15, 1, 0)
roc_log_model_t15 <- roc(recessions[445:696,2], prediction_log_model_t15)
auc(roc_log_model_t15) ##### area under the curve of the model: 0.8085
plot(roc_log_model_t15)
```
...
prediction_log_model_t18 <- ifelse(predict(log_model_t18, test_data_t18, type="response") >= 0.15, 1, 0)
roc_log_model_t18 <- roc(recessions[445:696,2], prediction_log_model_t18)
auc(roc_log_model_t18) ##### area under the curve of the model: 0.7953
plot(roc_log_model_t18)
```
...
prediction_log_model_t21 <- ifelse(predict(log_model_t21, test_data_t21, type="response") >= 0.15, 1, 0)
roc_log_model_t21 <- roc(recessions[445:696,2], prediction_log_model_t21)
auc(roc_log_model_t21) ##### area under the curve of the model: 0.782
plot(roc_log_model_t21)
```
...
prediction_log_model_t24 <- ifelse(predict(log_model_t24, test_data_t24, type="response") >= 0.15, 1, 0)
roc_log_model_t24 <- roc(recessions[445:696,2], prediction_log_model_t24)
auc(roc_log_model_t24) ##### area under the curve of the model: 0.72
plot(roc_log_model_t24)
```
...
```{r}
####### MODEL WITH ALL AVAILABLE SPREAD RATES IN OUR DATA SET, EXCLUDING THE RATES WE CRAFTED FROM FED SPREADS 
...
prediction_log_model_t12_all <- ifelse(predict(log_model_t12_all, test_data_t12_all, type="response") >= 0.15, 1, 0)
roc_log_model_t12_all <- roc(recessions[445:696,2], prediction_log_model_t12_all)
auc(roc_log_model_t12_all) ##### area under the curve of the model:  0.736
plot(roc_log_model_t12_all)
```
...
prediction_log_model_t15_all <- ifelse(predict(log_model_t15_all, test_data_t15_all, type="response") >= 0.15, 1, 0)
roc_log_model_t15_all <- roc(recessions[445:696,2], prediction_log_model_t15_all)
auc(roc_log_model_t15_all) ##### area under the curve of the model: 0.7915
plot(roc_log_model_t15_all)
```
...
prediction_log_model_t18_all <- ifelse(predict(log_model_t18_all, test_data_t18_all, type="response") >= 0.15, 1, 0)
roc_log_model_t18_all <- roc(recessions[445:696,2], prediction_log_model_t18_all)
auc(roc_log_model_t18_all) ##### area under the curve of the model:   0.7982
plot(roc_log_model_t18_all)
```
...
prediction_log_model_t21_all <- ifelse(predict(log_model_t21_all, test_data_t21_all, type="response") >= 0.15, 1, 0)
roc_log_model_t21_all <- roc(recessions[445:696,2], prediction_log_model_t21_all)
auc(roc_log_model_t21_all) ##### area under the curve of the model:   0.813
plot(roc_log_model_t21_all)
```
...
prediction_log_model_t24_all <- ifelse(predict(log_model_t24_all, test_data_t24_all, type="response") >= 0.15, 1, 0)
roc_log_model_t24_all <- roc(recessions[445:696,2], prediction_log_model_t24_all)
auc(roc_log_model_t24_all) ##### area under the curve of the model:  0.669
plot(roc_log_model_t24_all)
```
...
```{r}
####### PCA MODEL WITH ALL AVAILABLE SPREAD RATES IN OUR DATA SET, EXCLUDING THE RATES WE CRAFTED FROM FED SPREADS 

log_model_t12_all_PC <- glm(RECESSIONS ~ PC1 + PC2 + PC3, data= train_data_t12_all, family=binomial)
summary(log_model_t12_all_PC)

prediction_log_model_t12_all_PC <- ifelse(predict(log_model_t12_all_PC, test_data_t12_all, type="response") >= 0.15, 1, 0)
roc_log_model_t12_all_PC <- roc(recessions[445:696,2], prediction_log_model_t12_all_PC)
auc(roc_log_model_t12_all_PC) ##### area under the curve of the model:    0.7405
plot(roc_log_model_t12_all_PC)
```
...
prediction_log_model_t15_all_PC <- ifelse(predict(log_model_t15_all_PC, test_data_t15_all, type="response") >= 0.15, 1, 0)
roc_log_model_t15_all_PC <- roc(recessions[445:696,2], prediction_log_model_t15_all_PC)
auc(roc_log_model_t15_all_PC) ##### area under the curve of the model:  0.759
plot(roc_log_model_t15_all_PC)
```
...
prediction_log_model_t18_all_PC <- ifelse(predict(log_model_t18_all_PC, test_data_t18_all, type="response") >= 0.15, 1, 0)
roc_log_model_t18_all_PC <- roc(recessions[445:696,2], prediction_log_model_t18_all_PC)
auc(roc_log_model_t18_all_PC) ##### area under the curve of the model: 0.776
plot(roc_log_model_t18_all_PC)
```
...
prediction_log_model_t21_all_PC <- ifelse(predict(log_model_t21_all_PC, test_data_t21_all, type="response") >= 0.15, 1, 0)
roc_log_model_t21_all_PC <- roc(recessions[445:696,2], prediction_log_model_t21_all_PC)
auc(roc_log_model_t21_all_PC) ##### area under the curve of the model: 0.7716
plot(roc_log_model_t21_all_PC)
```
...
prediction_log_model_t24_all_PC <- ifelse(predict(log_model_t24_all_PC, test_data_t24_all, type="response") >= 0.15, 1, 0)
roc_log_model_t24_all_PC <- roc(recessions[445:696,2], prediction_log_model_t24_all_PC)
auc(roc_log_model_t24_all_PC) ##### area under the curve of the model:  0.7805
plot(roc_log_model_t24_all_PC)
```
